                        ...
                        <div class="body">
                            <form class="form-auth-small" action="<?= base_url('login');?>" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="signin-email" value="user@domain.com" placeholder="Email" required>
                                </div>
                                <div class="form-group">
                                    <label for="signin-password" class="control-label sr-only">Password</label>
                                    <input type="password" name="password" class="form-control" id="signin-password" value="thisisthepassword" placeholder="Password" required>
                                </div>
