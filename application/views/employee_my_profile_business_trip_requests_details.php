                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Business-Trip Request Details</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>business-trip-requests">Business-Trip</a></li>   
                            ...
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <p><?php echo $details['trip_route'] ?></p>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <small class="text-muted">Project Name</small>
                                        <p><?php echo $details['project_name']; ?></p>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        ...
                                        <p><?php echo strtoupper($details['is_accommodation_required']); ?></p>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        ...
                                        <p><?php echo strtoupper($details['is_on_hand_cash_required']); ?></p>
                                    </div>
                                    <?php if($details['is_on_hand_cash_required'] == 'yes'){ ?>
                                    <div class="col-lg-4 col-md-12">
                                        <small class="text-muted"><?php echo REQUEST_BUSINESS_ON_HAND_AMMOUNT; ?></small>
                                        <p><?php echo $details['cash_amount']; ?></p>
                                    </div>
                                    <?php } ?>
                                    <div class="col-lg-4 col-md-12">
                                        <small class="text-muted"><?php echo REQUEST_BUSINESS_CAR; ?></small>
                                        <p><?php echo strtoupper($details['is_car_required']); ?></p>
                                    </div>
                                </div>                                
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            request.onload = function() {
                window.location.href = "<?= site_url('business-trip-request/details/'.base64_encode($details['id'])); ?>";
            };
