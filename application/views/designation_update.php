    	...
    	<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><?php echo DESIGNATION_UPDATE; ?></li>
                        </ul>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            <form action="<?= base_url('designation/update');?>" id="create-designation" method="post" novalidate>
                            <input type="hidden" name="id" value="<?php echo base64_encode($details['id']); ?>">
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="<?php echo DESIGNATION_NAME; ?>" value="<?php echo $details['name']; ?>" required>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        <label><?php echo DESIGNATION_DETAILS; ?></label>
                                        <textarea class="form-control" name="detail" placeholder="<?php echo DESIGNATION_DETAILS; ?>"><?php echo $details['detail']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                ...
                                <br>
                                <button type="submit" class="btn btn-success"><?php echo DESIGNATION_SAVE; ?></button>
