    	...
    	<div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="request-leave" action="<?= base_url('requests/leave');?>" method="post" novalidate enctype="multipart/form-data">
                            <input type="hidden" name="employee_id" value="<php echo $employee_id; ?>">
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6 col-md-12">
                                        <label><?php echo REQUEST_LEAVE_EMPLOYEE; ?></label>
                                        <select name="employee_id" id="employee_id" class="form-control show-tick ms select2" data-placeholder="Select" required>
                                            <option value=""><?php echo REQUEST_LEAVE_SELECT_EMPLOYEE; ?></option>
                                            <?php
                                            if(!empty($employees)){
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo REQUESTS_LEAVE_DATE; ?></label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label><?php echo REQUESTS_LEAVE_ASSIGN_USER; ?></label>
                                        <select name="assigned_fmc_user_id" id="assigned_fmc_user_id" class="form-control show-tick ms select2" data-placeholder="Select" required>
                                            <option value=""><?php echo REQUESTS_LEAVE_SELECT_USER; ?></option>
                                            <?php
                                            if(!empty($fmc_users)){
