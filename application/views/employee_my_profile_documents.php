                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Personal Documents</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>                                                       
                                <li class="breadcrumb-item active">Personal Documents</li>
                            </ul>
                        </div>            
                                            ...
                                            <table class="table m-b-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank" href="../uploads/<?php echo $value['document_file']; ?>">Download</a></td>
                                                    </tr>
                                                    <?php
                                                    }
                                                    ?>
