            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <a href="<?= site_url(); ?>fmc-salary-components/create" class="btn btn-info"><?php echo SALARY_COMPONENT_ADD; ?></a>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                    ...
                                    if(!empty($items)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <a href="<?= site_url(); ?>fmc-salary-components/update/<?= base64_encode($value['id']);?>" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></a>
...
function deleteItem(id)
{
    swal({
        ...
        show_page_loader();
        $.ajax({
            url: "<?= site_url('fmc_salarycomponents/delete/'); ?>",
            type: 'post',
