  ...
  <div id="main-content" class="profilepage_2 blog-page">
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Confirm Employee Request</h2>
                    <ul class="breadcrumb">
        ...
        <?php if($request_details['status'] == 'in_approval'){ ?>
            <form action="<?= base_url('requests/approve_decline_employee_confirm_request');?>" id="request-details-form" method="post" novalidate>
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            request.onload = function() {
                window.location.href = "<?= site_url('requests/confirm_employee_request_details/'.base64_encode($request_details['id'])); ?>";
            };
