...
<div class="modal animated jello" id="add_new_leave_type" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_leave_type_form" action="<?= base_url('leavemanagement/create_leave_type');?>">
...
<div class="modal animated jello" id="update_leave_type" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_leave_type_form" action="<?= base_url('leavemanagement/update_leave_type');?>">
...
<div class="modal animated jello" id="add_new_leave_group" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_leave_group_form" action="<?= base_url('leavegroup/create');?>">
                <div class="modal-header">
...
<div class="modal animated jello" id="update_leave_group" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_leave_group_form" action="<?= base_url('leavegroup/update');?>">
                <input type="hidden" name="id" value="">
                <div class="modal-header">
...
<div class="modal animated jello" id="add_new_holiday" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_holiday_form" action="<?= base_url('holidays/create');?>">
            <div class="modal-header">
...
<div class="modal animated jello" id="update_holiday" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_holiday_form" action="<?= base_url('holidays/update');?>">
            <input type="hidden" name="id" value="">
            <div class="modal-header">
...
<div class="modal animated jello" id="add_new_holiday_group" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_holiday_group_form" action="<?= base_url('holidaygroup/create');?>">
                <div class="modal-header">
...
<div class="modal animated jello" id="update_holiday_group" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_holiday_group_form" action="<?= base_url('holidaygroup/update');?>">
                <input type="hidden" name="id" value="">
                <div class="modal-header">
...
<div class="modal animated jello" id="add_new_workweek" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_workweek_form" action="<?= base_url('workweek/create');?>">
                <div class="modal-header">
...
<div class="modal animated jello" id="update_workweek" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_workweek_form" action="<?= base_url('workweek/update');?>">
            <input type="hidden" name="id" value="">
                <div class="modal-header">
...
<div class="modal animated jello" id="add_new_workshift" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="add_new_workshift_form" action="<?= base_url('workshift/create');?>">
                <div class="modal-header">
...
<div class="modal animated jello" id="update_workshift" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" id="update_workshift_form" action="<?= base_url('workshift/update');?>">
            <input type="hidden" name="id" value="">
                <div class="modal-header">
...
<script type="text/javascript">
    ...
    function getLeaveType(id){
        show_page_loader();
        $.ajax({
            url: "<?= base_url('leavemanagement/get_leave_type');?>",
            method: "POST",
            data: { id : id },
    ...
    function deleteLeaveType(id){
        swal({
            ...
            $.ajax({
                url: "<?= site_url('leavemanagement/delete_leave_type/'); ?>",
                type: 'post',
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('leavemanagement'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('leavemanagement'); ?>";
                }
    ...
    function deleteLeaveGroup(id){
        swal({
            ...
            $.ajax({
                url: "<?= site_url('leavegroup/delete/'); ?>",
                type: 'post',
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('leavegroup'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('leavegroup'); ?>";
                }
    ...
    function deleteHoliday(id){
        swal({
            ...
            $.ajax({
                url: "<?= site_url('holidays/delete/'); ?>",
                type: 'post',
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('holidays'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('holidays'); ?>";
                }
    ...
    function deleteHolidayGroup(id){
        swal({
            ...
            $.ajax({
                url: "<?= site_url('holidaygroup/delete/'); ?>",
                type: 'post',
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('holidaygroup'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('holidaygroup'); ?>";
                }
    ...
    function deleteWorkweek(id){
        swal({
            ...
            $.ajax({
                ...
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('workweek'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('workweek'); ?>";
                }
    ...
    function deleteWorkShift(id){
        swal({
            ...
            $.ajax({
                url: "<?= site_url('workshift/delete/'); ?>",
                type: 'post',
                data: {'id': id,'status': 'deleted'},
                success: function (data) {
                    window.location.href = "<?= site_url('workshift'); ?>";
                },
                error: function () {
                    window.location.href = "<?= site_url('workshift'); ?>";
                }
