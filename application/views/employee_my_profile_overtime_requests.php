                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Ovetime Requests</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>                                                       
                                <li class="breadcrumb-item active">Ovetime Requests</li>
                            </ul>
                        </div>            
                        <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                            <a href="<?= site_url(); ?>overtime-requests/create" class="btn btn-info">Request Overtime</a>
                        </div>
                    </div>
                </div>                
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                        ...
                                        foreach ($overtime_requests as $key => $overtime_value) {
                                            if($overtime_value['request_status'] == "created"){
                                                $request_status_class = "badge-default";
                                            }
                                            if($overtime_value['request_status'] == "in_approval"){
                                                $request_status_class = "badge-default";
                                            }
                                            if($overtime_value['request_status'] == "approved"){
                                                $request_status_class = "badge-success";             
                                            }
                                            if($overtime_value['request_status'] == "declined" || $overtime_value['request_status'] == "deleted"){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url(); ?>overtime-request/details/<?php echo base64_encode($overtime_value['id']); ?>"><button type="button" class="btn btn-info"><i class="fa fa-eye"></i></button></a>
                                            </td>
                                        </tr>
                                        <?php    
                                        }
