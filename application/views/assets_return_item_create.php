        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="body">
                        <form action="<?= base_url('assets_return/create');?>" id="return-item-form" method="post" novalidate>
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-lg-12 col-md-6">
                                    ...
                                    <select class="form-control show-tick ms select2" data-placeholder="Select" name="return_conditions" id="return_conditions" required>
                                        ...
                                        <option value="new"><?php echo ASSETS_NEW; ?></option>
                                        <option value="used"><?php echo ASSETS_USED; ?></option>
                                        <option value="partially_damaged"><?php echo ASSETS_PARTIALLY_DAMAGED; ?></option>
                                        <option value="fully_damaged"><?php echo ASSETS_FULLY_DAMAGED; ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input data-provide="datepicker" data-date-autoclose="true" class="form-control" data-date-format="dd/mm/yyyy" name="return_date" id="return_date" placeholder="Return Date" autocomplete="off"  readonly required value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="form-group col-lg-12 col-md-6">
                                    <label>Note</label>
                                    <textarea class="form-control" placeholder="Note" name="return_note" id="return_note"></textarea>
                                </div>                
                            </div>
                            <div class="row clearfix">
