    	...
    	<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><?php echo REQUEST_TYPE_CREATE; ?></li>
                        </ul>
                    </div>            
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            <form action="<?= base_url('request_types/create');?>" id="create-request_type" method="post" novalidate>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        <label><?php echo REQUEST_TYPE_NAME; ?><span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="name" placeholder="<?php echo REQUEST_TYPE_NAME; ?>" required>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        <label><?php echo REQUEST_TYPE_DESCRIPTION; ?></label>
                                        <textarea class="form-control" name="description" placeholder="<?php echo REQUEST_TYPE_DESCRIPTION; ?>"></textarea>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                ...
                                <br>
                                <button type="submit" class="btn btn-success"><?php echo REQUEST_TYPE_CREATE; ?></button>
