                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Leave Requests</h2>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                            <a href="<?= site_url(); ?>leave-requests/create" class="btn btn-info">Create Leave Request</a>
                        </div>
                    </div>
                </div>                
                                        ...
                                        <tbody>
                                            ...
                                            if(!empty($leave_requests)){
                                                foreach ($leave_requests as $key => $leave_value) {
                                                    if($leave_value['request_status'] == "created"){
                                                        $request_status_class = "badge-default";
                                                    }
                                                    if($leave_value['request_status'] == "in_approval"){
                                                        $request_status_class = "badge-default";
                                                    }
                                                    if($leave_value['request_status'] == "approved"){
                                                        $request_status_class = "badge-success";
                                                    }
                                                    if($leave_value['request_status'] == "declined" || $leave_value['request_status'] == "deleted"){
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= site_url(); ?>leave-request/details/<?php echo base64_encode($leave_value['id']); ?>"><button type="button" class="btn btn-info"><i class="fa fa-eye"></i></button></a>
                                                        </td>
                                                    </tr>
                                                <?php    
                                                    }
