  ...
  <div id="main-content" class="profilepage_2 blog-page">
    <div class="container-fluid">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Employee -  Send For Approval</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item">Send For Approval</li>
                    </ul>
                </div>            
            ...
            <div class="body card-panel-body" id="positional_information">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p><?php echo $details['job_position_title'] ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php 
                            if(!empty($details['annual_ctc'])){
                                echo round($details['annual_ctc']/12,2); 
                            }
                            ?>
                        </div>
                    </div>
        ...
        <div class="card planned_task">
            ...
            <div class="body">
                <form action="<?= base_url('employees/send_for_approval/'.base64_encode($id));?>" id="create-client" method="post" novalidate>
                <input type="hidden" name="id" value="<?php echo base64_encode($id); ?>">
                    <div class="row">
                        <div class="col-md-12">
                        <?php 
                        $error_count = 0;
                        if($details['employee_code'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Employee-Code should not blank.</div>';
                        }
                        if($details['fullname_english'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Name should not blank.</div>';
                        }
                        if($details['fullname_arabic'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Arabic Name should not blank.</div>';
                        }
                        if($details['profile_pic'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Profile-Picture should not blank.</div>';
                        }
                        if($details['mobile'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Mobile should not blank.</div>';
                        }
                        if($details['email'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Email should not blank.</div>';
                        }
                        if($details['password'] == ""){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Password should not blank.</div>';
                        }
                        if($details['joining_date'] == "0000-00-00"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Joining Date should not blank.</div>';
                        }
                        if($details['attendance_start_date'] == "0000-00-00"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Attendance Start Date should not blank.</div>';
                        }

                        if(empty($details['job_position']) || $details['job_position'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Job-Position should not blank.</div>';
                        }
                        if(empty($details['designation']) || $details['designation'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Designation should not blank.</div>';
                        }
                        if(empty($details['department']) || $details['department'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Department should not blank.</div>';
                        }

                        if(empty($details['mother_city_address'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Mother City - Address should not blank.</div>';
                        }

                        if(empty($details['mother_city_city'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Mother City - City should not blank.</div>';
                        }

                        if(empty($details['mother_city_state'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Mother City - State should not blank.</div>';
                        }

                        if(empty($details['kingdom_po_box'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - PO Box should not blank.</div>';
                        }
                        ...
                        if(empty($details['kingdom_building_no'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - Building Number should not blank.</div>';
                        }

                        if(empty($details['kingdom_street_name'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - Street Name should not blank.</div>';
                        }

                        if(empty($details['kingdom_region_id']) || $details['kingdom_region_id'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - Region should not blank.</div>';
                        }

                        if(empty($details['kingdom_city_id']) || $details['kingdom_city_id'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - City should not blank.</div>';
                        }

                        if(empty($details['kingdom_zipcode'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Address In Kingdom - Zipcode should not blank.</div>';
                        }

                        if(count($emergency_contacts) == 0){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Emergenct Contacts, should be at least one person mandatory</div>';   
                        }

                        if(empty($details['leave_group']) || $details['leave_group'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Leave-Group should not blank.</div>';
                        }
                        if(empty($details['holiday_group']) || $details['holiday_group'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Holiday-Group should not blank.</div>';
                        }
                        if(empty($details['work_group']) || $details['work_group'] == "0"){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Work-Group should not blank.</div>';
                        }                        
                        if(empty($details['annual_ctc'])){
                            $error_count++;
                            echo '<div class="col-lg-12 col-md-12 alert alert-warning login-alert has-error">Annual CTC should not blank.</div>';
                        }
                        ...
                        <div class="col-md-12">
                            <div class="float-right">
                                <a href="<?= site_url(); ?>employees">
                                    <button type="button" name="previous" class="btn btn-danger">Cancel</button>
                                </a>
                                <button <?php echo ($error_count > 0) ? "disabled" : ""; ?> type="submit" name="save" class="btn btn-info">Assign</button>
                            </div>
                        </div>
                    </div>
                </form>
