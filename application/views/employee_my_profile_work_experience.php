                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Work Experience</h2>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                            <a href="<?= site_url(); ?>my-profile/add-work-experience" class="btn btn-info">Add Experience</a>
                        </div>
                    </div>
                </div>
