            ...
            <div class="vertical-align-middle auth-main">
                <div class="auth-box">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="<?= base_url('verify-otp/'.base64_encode($id));?>" method="post">
                                <div class="form-group">
                                    <input type="text" name="opt_code" class="form-control mb-2" id="" placeholder="OTP Code" required>
                                    <span class="helper-text">If you don’t receive a code ! <a href="<?= site_url(); ?>login/resend_otp/<?php echo base64_encode($id); ?>">Resend</a></span>
                                </div>
