    	...
    	<div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="request-overtime" action="<?= base_url('requests/overtime');?>" method="post" novalidate enctype="multipart/form-data">
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label><?php echo REQUEST_OVERTIME_TITLE; ?></label>
                                        <select name="employee_id" id="employee_id" class="form-control show-tick ms select2" data-placeholder="Select" required>
                                            <option value=""><?php echo REQUEST_OVERTIME_SELECT_EMPLOYEE; ?></option>
                                            <?php
                                            if(!empty($employees)){
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                         <div class="form-group">
                                             ...
                                             <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="from_time" class="form-control time12" placeholder="<?php echo REQUEST_OVERTIME_FROM_TIME_EX; ?>">
                                             </div>
                                         </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            <label><?php echo REQUEST_OVERTIME_TO_TIME; ?></label>
                                                ...
                                                <input type="text" name="to_time" class="form-control time12" placeholder="<?php echo REQUEST_OVERTIME_FROM_TIME_EX; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>                                
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <label for="document_file" class="dragndrop">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-primary"><?php echo REQUEST_OVERTIME_BROWSE_FILE; ?></button>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6 col-md-6">
                                        <label><?php echo REQUEST_OVERTIME_ASSIGN_USER; ?> </label>
                                        <select name="assigned_fmc_user_id" id="assigned_fmc_user_id" class="form-control show-tick ms select2" data-placeholder="Select" required>
                                            <option value=""><?php echo REQUEST_OVERTIME_SELECT_USER; ?></option>
                                            <?php
                                            if(!empty($fmc_users)){
