                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><?php echo DEPARTMENT_CREATE_DIVISION; ?></li>
                        </ul>
                    </div>            
                            ...
                            <form id="create-division" method="post" novalidate>
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        <label><?php echo DEPARTMENT_TITLE; ?></label>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-lg-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="module_name" placeholder="<?php echo DEPARTMENT_PLACEHOLDER_NAME; ?>" required>
                                    </div>
                                </div>
                                
                                
                                <br>
                                <button type="submit" class="btn btn-success"><?php echo DEPARTMENT_CREATE_DIVISION; ?></button>
                                <a href="<?= site_url(); ?>departments"><button type="button" class="btn btn-danger"><?php echo DEPARTMENT_CANCEL; ?></button></a>
                            </form>                           
                        </div>
                    </div>
                </div>
