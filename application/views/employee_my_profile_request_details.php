<div id="wrapper">
    ...
    <div id="main-content">        
        <div class="container-fluid">
                            ...
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <p><?php echo date('d-m-Y',strtotime($request_details['created_at'])); ?></p>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                ...
                <form action="<?= base_url('myprofile_requests/approve_decline');?>" id="request-details-form" method="post" novalidate>
                ...
                <div class="row clearfix">
                    <div class="col-lg-7">
                        <div class="float-right">
                            ...
                            submit_btn" class="btn btn-success">Approve</button>
                            <button type="submit" name="declined" value="next_btn" class="btn btn-danger">Decline</button>
                        </div>
                    </div>
                </div>
                </form>
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            request.onload = function() {
                window.location.href = "<?= site_url('employee-request/'.base64_encode($request_details['id'])); ?>";
            };
