                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Business-Trip Requests</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>                                                       
                                <li class="breadcrumb-item active">Business-Trip Requests</li>
                            </ul>
                        </div>            
                        <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                            <a href="<?= site_url(); ?>business-trip-requests/create" class="btn btn-info">Create Business-Trip Request</a>
                        </div>
                    </div>
                </div>                
                                    ...
                                    <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                        ...
                                        if(!empty($business_trip_requests)){
                                            foreach ($business_trip_requests as $key => $business_trip_value) {
                                                if($business_trip_value['request_status'] == "created"){
                                                    $request_status_class = "badge-default";
                                                }
                                                if($business_trip_value['request_status'] == "in_approval"){
                                                    $request_status_class = "badge-default";
                                                }
                                                if($business_trip_value['request_status'] == "approved"){
                                                    $request_status_class = "badge-success";             
                                                }
                                                if($business_trip_value['request_status'] == "declined" || $business_trip_value['request_status'] == "deleted"){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= site_url(); ?>business-trip-request/details/<?php echo base64_encode($business_trip_value['id']); ?>"><button type="button" class="btn btn-info"><i class="fa fa-eye"></i></button></a>
                                                </td>
                                            </tr>
                                            <?php    
                                            }
