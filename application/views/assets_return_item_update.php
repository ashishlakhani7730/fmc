        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Return Assets Item</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="body">
                        <form action="<?= base_url('assets_return/update/'.base64_encode($details['id']));?>" id="return-item-form" method="post" novalidate>
                            <div class="row clearfix">
                                <div class="form-group col-lg-12 col-md-6">
                                    ...
                                    foreach ($employees as $key => $value) {
                                        ...
                                        if($details['employee_id'] == $value['id']){
                                            echo "<b>".$value['fullname_english']."</b>";
                                        }
                                    }
                                    ?>
                                </div>                
                                ...
                                <div class="form-group col-lg-12 col-md-6">
                                    ...
                                    foreach ($assets_item as $key => $value) {
                                        ...
                                        if($details['assets_item_id'] == $value['id']){
                                            $selected = "selected";
                                            echo "<b>".$value['item_name']." / ".$value['serial_number']." / ".$value['model']."</b>"; 
                                        }
                                    }
                                    ?>                                    
                                </div>                
                            ...
                            <div class="row clearfix">
                                <div class="form-group col-lg-12 col-md-6">
                                    ...
                                    <select class="form-control show-tick ms select2" data-placeholder="Select" name="return_conditions" id="return_conditions" required>
                                        <option value=""><?php echo ASSETS_SELECT_CONDITIONS; ?></option>
                                        <option value="new" <?php echo ($details['return_conditions'] == 'new') ? 'selected' : ''; ?>><?php echo ASSETS_NEW; ?></option>
                                        <option value="used" <?php echo ($details['return_conditions'] == 'used') ? 'selected' : ''; ?>><?php echo ASSETS_USED; ?></option>
                                        <option value="partially_damaged" <?php echo ($details['return_conditions'] == 'partially_damaged') ? 'selected' : ''; ?>><?php echo ASSETS_PARTIALLY_DAMAGED; ?></option>
                                        <option value="fully_damaged" <?php echo ($details['return_conditions'] == 'fully_damaged') ? 'selected' : ''; ?>><?php echo ASSETS_FULLY_DAMAGED; ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <?php 
                                        $return_date = date('d/m/Y',strtotime($details['return_date']));
                                        ?>
                                        <input data-provide="datepicker" data-date-autoclose="true" class="form-control" data-date-format="dd/mm/yyyy" name="return_date" id="return_date" placeholder="Return Date" autocomplete="off"  readonly required value="<?php echo $return_date; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="form-group col-lg-12 col-md-6">
                                    <label>Note</label>
                                    <textarea class="form-control" placeholder="Note" name="return_note" id="return_note"><?php echo $details['return_note']; ?></textarea>
                                </div>                
                            </div>
                            <div class="row clearfix">
...
<script type="text/javascript">
    $(function() {      
        var form_instance = $('#return-item-form').parsley();        
    }); 
</script>
...
<script type="text/javascript">
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            formData.append("return_conditions",$('#return_conditions').val());
            formData.append("return_date",$('#return_date').val());            
            formData.append("return_note",$('#return_note').val());
