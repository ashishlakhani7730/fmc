        ...
        <div class="container-fluid">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= site_url(); ?>fmc_calendar" class="active">
                                    <i class="icon-calendar"></i> Calendar View
                                </a>
                                <a href="<?= site_url(); ?>fmc_calendar/list_view" style="margin-left: 15px;" href="">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="body">
                            <a href="<?= site_url(); ?>fmc_calendar/create_event"><button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#addevent"><?php echo CALENDER_ADD_NEW_EVENT; ?></button></a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="body">
...
<script type="text/javascript">
    ...
    $('#calendar').fullCalendar({
        ...
        eventClick: function(info) {
            window.location = "fmc_calendar/event_detail/"+info.event_id;                 
        },
        defaultDate: date,
        editable: true,
