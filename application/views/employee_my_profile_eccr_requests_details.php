                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>ECCR Request Details</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>business-trip-requests">ECCR Requests</a></li>   
                            ...
                            <div class="body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <p>
                                        <?php
                                            if($details['request_type'] == 'position_change'){
                                                echo "POSITION CHANGE";
                                            }
                                            if($details['request_type'] == 'allowances_add'){
                                                echo "ADD ALLOWANCES";
                                            }
                                            if($details['request_type'] == 'allowances_descrease'){
                                                echo "DESCREASE ALLOWANCES";
                                            }
                                            if($details['request_type'] == 'salary_increment'){
                                                echo "SALARY INCREMENT";
                                            }
                                            if($details['request_type'] == 'location_change'){
                                                echo "LOCATION CHANGE";
                                            }
                                            if($details['request_type'] == 'department_change'){
                                                echo "DEPARTMENT CHANGE";
                                            }
                                            if($details['request_type'] == 'temporary_relocation'){
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            request.onload = function() {
                window.location.href = "<?= site_url('eccr-request/details/'.base64_encode($details['id'])); ?>";
            };
