                ...
                <div class="block-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Ovetime Request Details</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="<?= site_url(); ?>overtime-requests">Ovetime Requests</a></li>   
                            ...
                            <div class="body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <p><?php echo $details['from_time']." - ".$details['to_time']; ?></p>
                                    </div>
                                </div>
                                <div class="row">
    ...
    function sendModifiesList(e) {
        ...
        if(form_instance.isValid()){        
            ...
            request.onload = function() {
                window.location.href = "<?= site_url('overtime-request/details/'.base64_encode($details['id'])); ?>";
            };
