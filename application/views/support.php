            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a><?php echo NAVBAR_SUPPORT; ?></h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= site_url(); ?>dashboard"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active"><?php echo NAVBAR_SUPPORT; ?></li>
                        </ul>                        
                    </div>            
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <a href="<?= site_url(); ?>support/create" class="btn btn-info"><?php echo SUPPORT_CREATE_TICKETS; ?></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0">
                                    <thead>
                                        <tr>
                                            <th><?php echo SUPPORT_TITLE; ?></th>
                                            <th><?php echo SUPPORT_DESCRIPTION; ?></th>
                                            <th>***</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    if(!empty($items)){
                                        ...
                                        <tr>                                        
                                            ...
                                            <td>
                                                 <a href="<?= site_url(); ?>support/update/<?= base64_encode($value['id']);?>" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="fa fa-edit"></i></a>
